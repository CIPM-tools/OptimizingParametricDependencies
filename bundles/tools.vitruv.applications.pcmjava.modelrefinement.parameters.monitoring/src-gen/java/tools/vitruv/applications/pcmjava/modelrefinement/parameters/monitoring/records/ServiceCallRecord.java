...
public class ServiceCallRecord extends AbstractMonitoringRecord implements IMonitoringRecord.Factory, IMonitoringRecord.BinaryFactory, ServiceContextRecord {			
	 ...
	 *            returnValue
	 */
	public ServiceCallRecord(final String sessionId, final String serviceExecutionId, final String serviceId, final String parameters, final String callerServiceExecutionId, final String callerId, final long entryTime, final long exitTime, final String returnValue) {
	 ...
	 */
	@Deprecated
	public ServiceCallRecord(final ByteBuffer buffer, final IRegistry<String> stringRegistry) throws BufferUnderflowException {
