 ...
 * @since 1.10
 */
public class ResponseTimeRecord extends AbstractMonitoringRecord
     ...
     *            stopTime
     */
    public ResponseTimeRecord(final String sessionId, final String serviceExecutionId, final String internalActionId,
            final String resourceId, final long startTime, final long stopTime) {
     ...
     */
    @Deprecated
    public ResponseTimeRecord(final ByteBuffer buffer, final IRegistry<String> stringRegistry)
            throws BufferUnderflowException {
    ...
    public void serialize(IValueSerializer arg0) throws BufferOverflowException {
        ...
        arg0.putString(this.internalActionId);
        arg0.putString(this.resourceId);
        arg0.putLong(this.startTime);
        arg0.putLong(this.stopTime);
    }
