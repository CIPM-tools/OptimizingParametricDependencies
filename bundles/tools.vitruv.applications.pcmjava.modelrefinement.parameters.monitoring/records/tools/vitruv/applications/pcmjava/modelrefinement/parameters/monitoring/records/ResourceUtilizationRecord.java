...
public class ResourceUtilizationRecord extends AbstractMonitoringRecord
        implements IMonitoringRecord.Factory, IMonitoringRecord.BinaryFactory, RecordWithSession {
     ...
     *            timestamp
     */
    public ResourceUtilizationRecord(final String sessionId, final String resourceId, final double utilization,
     ...
     */
    @Deprecated
    protected ResourceUtilizationRecord(final Object[] values, final Class<?>[] valueTypes) { // NOPMD (values stored
                                                                                              // directly)
     ...
     */
    @Deprecated
    public ResourceUtilizationRecord(final ByteBuffer buffer, final IRegistry<String> stringRegistry)
            throws BufferUnderflowException {
    ...
    public void serialize(IValueSerializer arg0) throws BufferOverflowException {
        ...
        arg0.putString(this.resourceId);
        arg0.putDouble(this.utilization);
        arg0.putLong(this.timestamp);
    }
